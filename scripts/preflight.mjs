...
assert(/@media\(max-width:900px\)/.test(css), 'Layout mobile V11 ausente.')
assert(/v11-company-actions/.test(css) && /v11-lab-stage/.test(css), 'CSS público V11 incompleto.')
...
assert(pkg.version === '11.0.0', `Versão esperada 11.0.0; atual ${pkg.version}.`)
